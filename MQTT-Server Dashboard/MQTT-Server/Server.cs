...
public static class Server_ASP_NET_Samples
{
    ...
    sealed class MqttController
    {
        ...
        public Task GetMessagePublished(InterceptingPublishEventArgs eventArgs)
        {
            Console.WriteLine($"Mensagem - '{eventArgs.ApplicationMessage.ConvertPayloadToString()}'");
        ...
        {
            string filePath = @"C:\Users\ana\Documents\arquivo.json";
            try
            {
            ...
            {
                Console.WriteLine($"Ocorreu um erro ao salvar os dados: {ex.Message}");
            }
        }
    }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment environment, MqttController mqttController)
        {
            ...
            app.UseMqttServer(
                server =>
                {
                    ...
                    server.InterceptingPublishAsync += mqttController.GetMessagePublished; 
                });
        }
